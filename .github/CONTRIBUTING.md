...
When have reviewed all changed code and checked for any bugs or issues you can create a [new pull request](https://github.com/ryanlua/web-edit/compare) to get your changes merged.
